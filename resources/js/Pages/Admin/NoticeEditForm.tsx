...
export default function AdminNoticeEditForm({ notice, categories, statusList = {} }: Props) {
    // ⭕️ 既存レコードの値を初期値としてバインド
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 antialiased font-sans">
            <Head title={`【管理画面】お知らせ編集 #${notice.id}`} />
            ...
            <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-10 text-white">
                <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-md font-bold tracking-tight">お知らせ編集</h1>
                    </div>
