...
export default function AdminFairEditForm({ fair, categories, statusList = {} }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        title: fair.title,
        category: String(fair.category),
        status: String(fair.status),
        description: fair.description, // ⭕️ description に修正
            ...
            <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-10 text-white">
                <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-md font-bold tracking-tight">フェア編集</h1>
                    </div>
                        ...
                        <div>
                            ...
                            {fair.image_url && (
                                <div className="mb-3">
                                    ...
                                    <img 
                                        src={`/storage/${fair.image_url}`} 
                                        alt="Current Fair Image" 
