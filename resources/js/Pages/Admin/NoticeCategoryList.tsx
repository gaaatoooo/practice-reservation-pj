...
import { Plus, Trash2, Edit2, Check, X, CheckCircle2, XCircle } from 'lucide-react';
...
export default function AdminNoticeCategoryList({ categories }: Props) {
    ...
    const handleAddSubmit = (e: React.FormEvent) => {
        ...
        addForm.post('/admin/notice-categories', {
            onSuccess: () => {
                ...
                setFlashMessage({type: 'success', text: '新しいお知らせカテゴリを登録しました。'});
    ...
    const handleUpdateSubmit = (id: number) => {
        ...
        router.patch(`/admin/notice-categories/${id}`, { 
            name: editingName,
