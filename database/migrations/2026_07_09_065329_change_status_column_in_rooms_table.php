...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('rooms', function (Blueprint $table) {
            ...
            DB::statement('ALTER TABLE rooms ALTER COLUMN status TYPE integer USING (CASE WHEN status IS TRUE THEN 1 ELSE 3 END)');

            // 3. 新しいデフォルト値（1）を設定
            DB::statement('ALTER TABLE rooms ALTER COLUMN status SET DEFAULT 1');
        });
    }
    ...
    public function down(): void
    {
        Schema::table('rooms', function (Blueprint $table) {
            ...
            DB::statement('ALTER TABLE rooms ALTER COLUMN status TYPE boolean USING (CASE WHEN status = 1 THEN TRUE ELSE FALSE END)');
